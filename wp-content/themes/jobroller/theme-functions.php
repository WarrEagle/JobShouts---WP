...
<script type="text/javascript">
	...
	tinyMCEPreInit = {
		//base : "<?php echo includes_url('js/tinymce'); ?>", get_template_directory_uri().'/includes/tinymce3/tiny_mce.js'
		base : "<?php echo get_template_directory_uri().'/includes/tinymce3'; ?>",
		suffix : "",
		mceInit : {
