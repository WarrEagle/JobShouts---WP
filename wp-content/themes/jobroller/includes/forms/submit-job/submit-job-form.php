...
?>
	...
	<form action="<?php echo esc_url( $form_action ) ?>" method="post" enctype="multipart/form-data" id="submit_form" class="submit_form main_form">
		...
		<fieldset>
			...
			<p><?php _e('Fill in the company section to provide details of the company listing the job. If you have filled out your '); ?><a href="../my-profile">profile</a><?php _e(' this information will be
					stored for future use. Please do not use Confidential or anything similar for the Company name as this is a violation of our '); ?><a href="../terms-conditions/">Terms Of Service</a><?php _e(' and your job ad will be deleted without refund or warning.', APP_TD); ?></p>
		...
		<fieldset>
			...
			<p><?php _e('Do not leave this blank as jobs without locations will not be indexed. Make sure you click find address after you have entered the location.'); ?></p>	
